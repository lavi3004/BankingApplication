...
namespace BankingApplication.Migrations
{
    ...
    [Migration("20230509173515_UpdateTransaction2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankingApplication.Models.Card", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BankingApplication.Models.Transaction", b =>
                {
                    b.HasOne("BankingApplication.Models.BankAccount", "Reciver")
                        .WithMany()
                        .HasForeignKey("ReciverId");

                    b.HasOne("BankingApplication.Models.BankAccount", "Sender")
                        .WithMany()
